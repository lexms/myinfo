...
public class ListFriendsFragment extends AppCompatActivity {
...
//save
                    crud.save(name);
                    nameEditTxt.setText("");
                    adapter=new ArrayAdapter<String>(ListFriendsFragment.this,android.R.layout.simple_list_item_1,crud.getNames());
                    lv.setAdapter(adapter);
                }else
                {
                    Toast.makeText(ListFriendsFragment.this, "Name cannot be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
